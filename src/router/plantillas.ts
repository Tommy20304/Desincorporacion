...
plantilla.post("/retornar-columnas", verificarToken, cargar.single("fileExcel"), async (req:any, res) => {
...
plantilla.post("/guardar-archivo", verificarToken, cargar.single("fileExcel"), async (req:any, res) => {
