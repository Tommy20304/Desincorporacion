...
usuario.post("/agregar-administrador", verificarToken, async (req, res) => {
...
usuario.post("/quitar-administrador", verificarToken, async (req, res) => {
...
usuario.post("/activar-usuario", verificarToken, async (req, res) => {
...
usuario.post("/desactivar-usuario", verificarToken, async (req, res) => {
...
usuario.post("/cambiar-password", verificarToken, async (req, res) => {
    try {
