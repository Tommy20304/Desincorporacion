...
crearClave.post("/determinar-errores", verificarToken, cargar.single("fileExcel"), async (req, res) => {
...
crearClave.post("/agregar", verificarToken, cargar.single("fileExcel"), async (req, res) => {
    try {
