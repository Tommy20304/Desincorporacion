...
class BuscarDatos {
     ...
     */
    procesarComponentes(clave, valores) {
        /**
    ...
    armarConsulta(buscarDeshabilitado = null) {
        const filtros = [];
        for (let [clave, valor] of Object.entries(this.opciones)) {
            ...
            if (["componenteBueno", "componenteMalo"].includes(clave)) {
                ...
                if (clausulaComponente)
                    filtros.push(clausulaComponente);
                continue;
            }
