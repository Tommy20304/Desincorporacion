...
buscar.get("/bloque-busqueda", verificarToken, async (req, res) => {
    ...
    let tablasDosColumnas = ["categoria", "marca", "modelo", "ubicaciones"]; //tablas con solo dos columnas
...
buscar.post("/archivo", verificarToken, cargar.single("fileExcel"), async (req, res) => {
